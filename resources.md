...
A single plact to consolidate the various resources to help you run the hackathon.  You should have view access to these, but you'll probably need to make copies for when you run the hackathon. 
